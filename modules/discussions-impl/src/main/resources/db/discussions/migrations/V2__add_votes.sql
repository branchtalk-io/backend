...
ALTER TABLE posts
  ADD COLUMN upvotes_nr          INT NOT NULL DEFAULT 0 CHECK (upvotes_nr >= 0),
      ...
      COLUMN total_score         INT NOT NULL DEFAULT 0 CHECK (total_score = upvotes_nr - downvotes_nr),
      COLUMN controversial_score INT NOT NULL DEFAULT 0  CHECK (controversial_score = MAX(upvotes_nr, downvotes_nr));
